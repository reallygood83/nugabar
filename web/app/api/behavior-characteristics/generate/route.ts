...
## 작성 예시
✅ 올바른 예시 (종결어 다양화):
"수업에 적극적으로 참여하며 새로운 내용을 빠르게 이해함. 친구들과 협력하여 과제를 완수하고, 어려움에 처한 친구를 자연스럽게 도움. 맡은 일에 대한 책임감이 강하며, 꾸준한 노력으로 학습 능력이 향상됨."

❌ 잘못된 예시 (종결어 중복, 표현 반복):
"적극적으로 참여함. 적극적으로 도움을 줌함. 책임감이 강함. 책임감을 보임. 긍정적인 태도를 보임. 긍정적으로 참여함."
